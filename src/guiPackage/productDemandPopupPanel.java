...
/**
 * A class to construct the product demand report popup
...
public class productDemandPopupPanel extends JPanel {
	 ...
	 * @param data arrayList containing productName and time period
	 ...
	 * @param productName the product to be searched for
	 * @return the monthly sales data for productName
	...
	/**
	 * Predict the next value in a series of data
	 * Uses a linear prediction algorithm in the form y = ax + b
	 * Data is assumed to be 1D (only y values),
	 * it is assumed x values are in the range 1..(n+1),
	 * where n is data.length.
	 * @param data the 1-D data to be used to predict next value
